...
public class Cellule {
    ...
    /**
     * Permet de modifier les murs de la cellule
     *
     * @param murs tableau de booléens correspondant à la présence
     *             ou non de murs dans les directions N, S, E et O
     * @throws IllegalArgumentException exception si le mur est invalide
     */
    public void setMurs(boolean valeur, int mur) {
        if (mur < 0 || 3 < mur) {
            throw new IllegalArgumentException("mur invalide");
        }
        this.murs[mur] = valeur;
    }
