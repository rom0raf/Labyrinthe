...
public class CreationBacktracking {
    ...
    private void casserMur(Cellule pieceCourante, Cellule pieceVoisine) {
	    ...
	    if (largeur1 == largeur2 && hauteur1 < hauteur2) {
            pieceCourante.modifierMur('E', false); // Ouvrir un passage à l'est dans cellule1
            pieceVoisine.modifierMur('O', false); // Ouvrir un passage à l'ouest dans cellule2
        } else if (largeur1 == largeur2 && hauteur1 > hauteur2) {
            pieceCourante.modifierMur('O', false); // Ouvrir un passage à l'ouest dans cellule1
            pieceVoisine.modifierMur('E', false); // Ouvrir un passage à l'est dans cellule2
        } else if (hauteur1 == hauteur2 && largeur1 < largeur2) {
            pieceCourante.modifierMur('S', false); // Ouvrir un passage au sud dans cellule1
            pieceVoisine.modifierMur('N', false); // Ouvrir un passage au nord dans cellule2
        } else if (hauteur1 == hauteur2 && largeur1 > largeur2) {
            pieceCourante.modifierMur('N', false); // Ouvrir un passage au nord dans cellule1
            pieceVoisine.modifierMur('S', false); // Ouvrir un passage au sud dans cellule2
        }
